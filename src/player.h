...
public:
    ...
    void setTempData(const Player *key, int value, bool clear_at_notactive = true);
    QList<int> getTempData(const Player *key) const;
    void clearTempData(bool is_clear = false);
...
private:
    ...
    QMap<const Player *, QList<int> > temp_data;
    bool clear_temp;
